...
const TotalAdStatus = () => {
  const [totalAdStatus, setTotalAdStatus] = useRecoilState<TotalAdStatusType[]>(totalAdStatusState);
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      >
        ...
        >
          <Grid item xs={12} md={4} sx={{ border: '1px solid black', borderRadius: '10px', p: 2 }}>
        ...
        <Container sx={{ display: 'flex', justifyContent: 'center', p: 2 }}>
          <LineChart width={900} height={400} data={data} margin={{ top: 20, right: 20, bottom: 40, left: 20 }}>
